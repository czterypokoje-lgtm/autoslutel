...
export default function RotterdamSeoContent() {
  return (
    <div className={styles.seoContent}>
      ...
      <p>
        Voorkom verrassingen en laat tijdig een reservesleutel bijmaken in Rotterdam. Onze specialisten programmeren dagelijks nieuwe transpondersleutels en smart keys voor nagenoeg alle automerken. Of u nu een compacte stadsauto rijdt in Kralingen of een zware bedrijfswagen in de Spaanse Polder, wij beschikken over de meest geavanceerde apparatuur. Wij lezen de startonderbreker veilig uit en frezen de nieuwe sleutel schadevrij en volgens de originele fabrieksspecificaties.
      </p>
      ...
      <ul>
        ...
        <li><strong>Vaste en Transparante Prijzen:</strong> U weet vooraf exact wat de kosten zijn—altijd scherper geprijsd dan de merkdealer.</li>
        <li><strong>Lokale Expertise:</strong> Jarenlange ervaring met alle grote automerken in het veeleisende Rotterdamse stadsverkeer.</li>
      </ul>
