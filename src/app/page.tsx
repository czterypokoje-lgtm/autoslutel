      ...
      <section className={styles.brandsSection}>
        <div className="container">
          ...
          <div className={styles.brandsLogoGrid}>
            {[
              { name: 'Volkswagen', slug: 'volkswagen-autosleutel-bijmaken', models: 'Golf, Polo, Tiguan, Passat', svg: 'https://www.car-logos.org/wp-content/uploads/2011/09/volkswagen.png' },
              { name: 'BMW', slug: 'bmw-autosleutel-bijmaken', models: '1-, 3-, 5-Serie, X1, X3, X5', svg: 'https://www.car-logos.org/wp-content/uploads/2011/09/bmw.png' },
              { name: 'Mercedes-Benz', slug: 'mercedes-autosleutel-bijmaken', models: 'A/C/E-Klasse, Sprinter, Vito', svg: 'https://www.car-logos.org/wp-content/uploads/2011/09/mercedes.png' },
              { name: 'Audi', slug: 'audi-autosleutel-bijmaken', models: 'A1, A3, A4, A6, Q3, Q5, Q7', svg: 'https://www.car-logos.org/wp-content/uploads/2011/09/audi.png' },
              { name: 'Opel', slug: 'opel-autosleutel-bijmaken', models: 'Corsa, Astra, Mokka, Vivaro', svg: 'https://www.car-logos.org/wp-content/uploads/2011/09/opel.png' },
              { name: 'Ford', slug: 'ford-autosleutel-bijmaken', models: 'Focus, Fiesta, Transit, Kuga', svg: 'https://www.car-logos.org/wp-content/uploads/2011/09/ford.png' },
              { name: 'Renault', slug: 'renault-autosleutel-bijmaken', models: 'Clio, Captur, Megane, Trafic', svg: 'https://www.car-logos.org/wp-content/uploads/2011/09/renault.png' },
              { name: 'Peugeot', slug: 'peugeot-autosleutel-bijmaken', models: '208, 308, 2008, 3008, Partner', svg: 'https://www.car-logos.org/wp-content/uploads/2011/09/peugeot.png' },
              { name: 'Toyota', slug: 'toyota-autosleutel-bijmaken', models: 'Aygo, Yaris, Corolla, RAV4', svg: 'https://www.car-logos.org/wp-content/uploads/2011/09/toyota.png' },
              { name: 'Seat', slug: 'seat-autosleutel-bijmaken', models: 'Ibiza, Leon, Arona, Ateca', svg: 'https://www.car-logos.org/wp-content/uploads/2011/09/seat.png' },
              { name: 'Skoda', slug: 'skoda-autosleutel-bijmaken', models: 'Fabia, Octavia, Superb, Kodiaq', svg: 'https://www.car-logos.org/wp-content/uploads/2011/09/skoda.png' },
              { name: 'Volvo', slug: 'volvo-autosleutel-bijmaken', models: 'V40, V60, XC40, XC60, XC90', svg: 'https://www.car-logos.org/wp-content/uploads/2011/09/volvo.png' },
              { name: 'Nissan', slug: 'nissan-autosleutel-bijmaken', models: 'Micra, Qashqai, Juke, Leaf', svg: 'https://www.car-logos.org/wp-content/uploads/2011/09/nissan.png' },
              { name: 'Hyundai', slug: 'hyundai-autosleutel-bijmaken', models: 'i10, i20, i30, Tucson, Kona', svg: 'https://www.car-logos.org/wp-content/uploads/2011/09/hyundai.png' },
              { name: 'Kia', slug: 'kia-autosleutel-bijmaken', models: 'Picanto, Rio, Ceed, Sportage', svg: 'https://www.car-logos.org/wp-content/uploads/2011/09/kia.png' },
              { name: 'Citroën', slug: 'citroen-autosleutel-bijmaken', models: 'C1, C3, C4, Berlingo, Jumper', svg: 'https://www.car-logos.org/wp-content/uploads/2011/09/citroen.png' },
              { name: 'Fiat', slug: 'fiat-autosleutel-bijmaken', models: '500, Panda, Ducato, Tipo', svg: 'https://www.car-logos.org/wp-content/uploads/2011/09/fiat.png' },
              { name: 'Honda', slug: 'honda-autosleutel-bijmaken', models: 'Civic, Jazz, CR-V, HR-V', svg: 'https://www.car-logos.org/wp-content/uploads/2011/09/honda.png' },
              { name: 'Mazda', slug: 'mazda-autosleutel-bijmaken', models: 'Mazda2, Mazda3, CX-5, MX-5', svg: 'https://www.car-logos.org/wp-content/uploads/2011/09/mazda.png' },
              { name: 'Land Rover', slug: 'land-rover-autosleutel-bijmaken', models: 'Range Rover, Discovery, Evoque', svg: 'https://www.car-logos.org/wp-content/uploads/2011/09/land-rover.png' },
              { name: 'Porsche', slug: 'porsche-autosleutel-bijmaken', models: 'Cayenne, Macan, 911, Panamera', svg: 'https://www.car-logos.org/wp-content/uploads/2011/09/porsche.png' },
              { name: 'Mini', slug: 'mini-autosleutel-bijmaken', models: 'Cooper, One, Countryman', svg: 'https://www.car-logos.org/wp-content/uploads/2011/09/mini.png' },
            ].map((brand) => (
              <Link
                key={brand.slug}
