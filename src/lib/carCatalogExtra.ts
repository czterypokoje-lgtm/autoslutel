...
export const EXTRA_MODELS: Record<string, string[]> = {
  bmw: [
    '1 Serie', '2 Serie', '2 Serie Active Tourer', '2 Serie Gran Coupé', '3 Serie',
    '4 Serie', '5 Serie', '6 Serie', '7 Serie', '8 Serie',
    'X1', 'X2', 'X3', 'X4', 'X5', 'X6', 'X7', 'XM',
    'Z1', 'Z3', 'Z4', 'Z8', 'i3', 'i4', 'i5', 'i7', 'i8',
    'iX', 'iX1', 'iX2', 'iX3',
    'M2', 'M3', 'M4', 'M5', 'M6', 'M8',
  ],
  ford: [
    'B-Max', 'C-Max', 'Grand C-Max', 'Capri', 'Cougar', 'Courier', 'EcoSport', 'Edge',
    'Escape', 'Escort', 'Explorer', 'F-150', 'Fiesta', 'Focus', 'Fusion', 'Galaxy',
    'KA', 'KA+', 'Kuga', 'Maverick', 'Mondeo', 'Mustang', 'Mustang Mach-E', 'Orion',
    'Probe', 'Puma', 'Ranger', 'S-Max', 'Scorpio', 'Sierra', 'Streetka', 'Tourneo',
    'Tourneo Connect', 'Tourneo Custom', 'Transit', 'Transit Connect',
    'Transit Courier', 'Transit Custom',
  ],
  volkswagen: [
    'Up!', 'Lupo', 'Fox', 'Polo', 'Golf', 'Golf Plus', 'Golf Sportsvan', 'Jetta', 'Bora',
    'Vento', 'Scirocco', 'Corrado', 'Beetle', 'New Beetle', 'Eos', 'Passat', 'Passat CC',
    'Arteon', 'Phaeton', 'T-Cross', 'T-Roc', 'Taigo', 'Tiguan', 'Tiguan Allspace',
    'Touran', 'Touareg', 'Sharan', 'Caddy', 'Transporter', 'Multivan', 'Caravelle',
    'California', 'Crafter', 'LT', 'Amarok',
    'ID.3', 'ID.4', 'ID.5', 'ID.7', 'ID. Buzz',
  ],
  kia: [
    'Picanto', 'Rio', 'Stonic', 'Ceed', "Cee'd", 'ProCeed', 'XCeed', 'Niro',
    'Soul', 'Sportage', 'Sorento', 'Carens', 'Carnival', 'Venga', 'Optima',
    'Magentis', 'Stinger', 'Cerato', 'Sephia', 'Shuma', 'Pride', 'Retona',
    'EV3', 'EV6', 'EV9',
  ],
  'mercedes-benz': [
    'A-Klasse', 'B-Klasse', 'C-Klasse', 'CLA', 'CLC', 'CLK', 'CLS', 'E-Klasse',
    'S-Klasse', 'G-Klasse', 'GL', 'GLA', 'GLB', 'GLC', 'GLE', 'GLK', 'GLS',
    'ML', 'R-Klasse', 'SL', 'SLC', 'SLK', 'SLR', 'SLS', 'AMG GT',
    'Citan', 'Vaneo', 'Viano', 'Vito', 'V-Klasse', 'Sprinter',
    'EQA', 'EQB', 'EQC', 'EQE', 'EQS', 'EQV',
  ],
  peugeot: [
    '106', '107', '108', '205', '206', '207', '208', '2008', '301', '306', '307', '308',
    '3008', '405', '406', '407', '408', '4007', '4008', '5008', '508', '605', '607',
    '806', '807', '1007', 'Bipper', 'Boxer', 'Expert', 'iOn', 'Partner', 'RCZ',
    'Rifter', 'Traveller',
  ],
  fiat: [
    '124 Spider', '500', '500C', '500e', '500L', '500X', 'Barchetta', 'Brava',
    'Bravo', 'Croma', 'Doblo', 'Ducato', 'Fiorino', 'Freemont', 'Grande Punto',
    'Idea', 'Marea', 'Multipla', 'Panda', 'Punto', 'Punto Evo', 'Qubo', 'Scudo',
    'Sedici', 'Seicento', 'Stilo', 'Talento', 'Tipo', 'Ulysse',
  ],
  opel: [
    'Adam', 'Agila', 'Ampera', 'Antara', 'Astra', 'Astra GTC', 'Cascada', 'Combo',
    'Corsa', 'Crossland', 'Frontera', 'Grandland', 'Insignia', 'Kadett', 'Karl',
    'Manta', 'Meriva', 'Mokka', 'Movano', 'Omega', 'Signum', 'Tigra', 'Vectra',
    'Vivaro', 'Zafira',
  ],
  toyota: [
    'Aygo', 'Aygo X', 'Yaris', 'Yaris Cross', 'Yaris Verso', 'Starlet', 'Corolla',
    'Corolla Cross', 'Corolla Verso', 'Auris', 'Avensis', 'Avensis Verso', 'Camry',
    'Carina', 'Celica', 'C-HR', 'iQ', 'MR2', 'Paseo', 'Picnic', 'Previa', 'Prius',
    'Prius+', 'Proace', 'Proace City', 'RAV4', 'Highlander', 'Hilux', 'Land Cruiser',
    'Supra', 'GT86', 'Urban Cruiser', 'Verso', 'Verso-S', 'bZ4X',
  ],
  renault: [
    'Twingo', 'Clio', 'Captur', 'Modus', 'Grand Modus', 'Megane', 'Megane E-Tech',
    'Fluence', 'Scenic', 'Grand Scenic', 'Talisman', 'Laguna', 'Latitude', 'Safrane',
    'Vel Satis', 'Avantime', 'Espace', 'Kadjar', 'Koleos', 'Arkana', 'Austral',
    'Zoe', 'Twizy', 'Kangoo', 'Trafic', 'Master', 'Wind',
  ],
  nissan: [
    'Almera', 'Almera Tino', 'Ariya', 'Cube', 'Juke', 'Leaf', 'Micra', 'Murano',
    'Navara', 'Note', 'NV200', 'NV300', 'NV400', 'Interstar', 'Pathfinder',
    'Patrol', 'Pixo', 'Primastar', 'Primera', 'Pulsar', 'Qashqai', 'Qashqai+2',
    'Terrano', 'Tiida', 'X-Trail', '350Z', '370Z', 'GT-R',
  ],
  hyundai: [
    'Accent', 'Atos', 'Bayon', 'Coupe', 'Elantra', 'Getz', 'Grandeur', 'H-1',
    'i10', 'i20', 'i30', 'i40', 'Ioniq', 'Ioniq 5', 'Ioniq 6', 'ix20', 'ix35',
    'Kona', 'Matrix', 'Santa Fe', 'Sonata', 'Terracan', 'Trajet', 'Tucson',
  ],
  citroen: [
    'AX', 'Berlingo', 'C1', 'C2', 'C3', 'C3 Aircross', 'C3 Picasso', 'C4',
    'C4 Aircross', 'C4 Cactus', 'C4 Picasso', 'C4 Spacetourer', 'C5',
    'C5 Aircross', 'C5 X', 'C6', 'C8', 'C-Crosser', 'C-Elysée', 'C-Zero',
    'DS3', 'DS4', 'DS5', 'Jumper', 'Jumpy', 'Nemo', 'Saxo', 'Xantia',
    'Xsara', 'Xsara Picasso', 'ZX',
  ],
  volvo: [
    '240', '440', '460', '480', '740', '850', '940', '960',
    'C30', 'C40', 'C70', 'S40', 'S60', 'S70', 'S80', 'S90',
    'V40', 'V50', 'V60', 'V70', 'V90', 'XC40', 'XC60', 'XC70', 'XC90', 'EX30',
  ],
  audi: [
    'A1', 'A2', 'A3', 'A4', 'A5', 'A6', 'A7', 'A8',
    'Q2', 'Q3', 'Q4 e-tron', 'Q5', 'Q7', 'Q8',
    'TT', 'R8', 'e-tron', 'e-tron GT', 'RS3', 'RS4', 'RS5', 'RS6', 'RS7',
    'S3', 'S4', 'S5', 'S6', 'S8', 'Allroad', 'Cabriolet', '80', '100',
  ],
  seat: [
    'Alhambra', 'Altea', 'Altea XL', 'Arona', 'Arosa', 'Ateca', 'Cordoba',
    'Exeo', 'Ibiza', 'Inca', 'Leon', 'Mii', 'Tarraco', 'Toledo',
  ],
  chevrolet: [
