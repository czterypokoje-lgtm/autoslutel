...
export const BRANDS: Brand[] = [
  ...
  },
  {
    ...
    models: [
      { slug: 'avantime', name: 'Avantime' },
      { slug: 'captur', name: 'Captur' },
      { slug: 'clio', name: 'Clio' },
      { slug: 'clio-ii', name: 'Clio II' },
      { slug: 'clio-iii', name: 'Clio III' },
      { slug: 'clio-iv', name: 'Clio IV' },
      { slug: 'coach', name: 'Coach' },
      { slug: 'espace-iii', name: 'Espace III' },
      { slug: 'espace-iv', name: 'Espace IV' },
      { slug: 'kangoo', name: 'Kangoo' },
      { slug: 'kadjar', name: 'Kadjar' },
      { slug: 'kyron', name: 'Kyron' },
      { slug: 'laguna', name: 'Laguna' },
      { slug: 'laguna-ii', name: 'Laguna II' },
      { slug: 'laguna-iii', name: 'Laguna III' },
      { slug: 'megane', name: 'Megane' },
      { slug: 'megane-ii', name: 'Megane II' },
      { slug: 'megane-iii', name: 'Megane III' },
