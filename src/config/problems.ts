...
export const PROBLEMS: Problem[] = [
  {
    ...
    metaDesc: 'Autosleutel kwijt? Wij helpen direct! Nieuwe sleutel programmeren aan huis. Alle merken. 24/7. Bel nu: 06-XX XX XX XX',
  ...
  },
  {
    ...
    metaDesc: 'Auto op slot en sleutels erin vergeten? Wij openen uw auto schadevrij. 24/7. Reactietijd 30-60 min. Bel: 06-XX XX XX XX',
  ...
  },
  {
    ...
    metaDesc: 'Auto openen zonder sleutel? Wij openen uw voertuig schadevrij en professioneel. Geen schade aan slot of portier. Bel: 06-XX XX XX XX',
  ...
  },
  {
    ...
    metaDesc: 'Autosleutel spoed? 24/7 mobiele hulp. Gemiddeld 30-60 min reactietijd. Alle merken. Bel nu: 06-XX XX XX XX',
  ...
  },
  {
    ...
    metaDesc: '24 uur per dag, 7 dagen per week autoslotenmaker. Nacht, weekend, feestdagen. +25% toeslag buiten kantooruren. Bel: 06-XX XX XX XX',
